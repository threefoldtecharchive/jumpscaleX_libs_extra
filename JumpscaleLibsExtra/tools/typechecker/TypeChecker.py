...
class Option(j.baseclasses.object):
    def __init__(self):
        JSBASE.__init__(self)
...
class TypeCheckerFactory(j.baseclasses.object):
    """

    """

    __jslocation__ = "j.tools.typechecker"
...
class TypeChecker(j.baseclasses.object):
