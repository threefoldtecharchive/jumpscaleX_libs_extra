...
simulation.components.new(name="ssd1", description="1 TB Samsung Evo", cost=350, sru=1000, power=5, su_perc=100)
simulation.components.new(name="mem32_ecc", description="mem 32", cost=300, mru=32, power=8, cu_perc=100)
simulation.components.new(name="mem64_ddr4", description="mem 2x32", cost=400, mru=64, power=16, cu_perc=100)
simulation.components.new(
    name="ng2",
...
d = simulation.devices.new(name="dc1")
...
# create the template for edge device 1
d = simulation.devices.new(name="edge1")
...
d = simulation.devices.new(name="switch")
